...
ant -f C:/Users/A.Petersell/Dropbox/com.ditalog.kirby.txt/sample/build-sample.xml -Dpubname=content-first-chapter -logger org.dita.dost.log.DITAOTBuildLogger %1